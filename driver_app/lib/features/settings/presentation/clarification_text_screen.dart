...
class ClarificationTextScreen extends StatelessWidget {
  const ClarificationTextScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'settings.clarification_title'.tr(),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'settings.clarification_text'.tr(),
                      style: TextStyle(
                        fontSize: 16,
                        height: 1.6,
