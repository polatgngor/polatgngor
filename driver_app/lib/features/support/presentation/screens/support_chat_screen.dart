...
class _SupportChatScreenState extends ConsumerState<SupportChatScreen> {
  ...
  // Socket logic excluded for Driver app as previously decided, because socket_service mismatch
  // Using HTTP-only for messages for now.
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      _loadMessages(); // Reload since no socket
    } catch (e) {
      if (mounted) {
                          ...
                          return Align(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: isUser ? const Color(0xFF1A77F6) : Colors.white,
